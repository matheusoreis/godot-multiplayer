...
func _on_close_pressed() -> void:
	...
	(_scene as Menu).show_interface(&"SignIn")
	(_scene as Menu).hide_interface(&"SignUp")
...
func _on_sign_up_pressed() -> void:
	...
	var password_confirm: String = %PasswordConfirm.text
	...
	if password != password_confirm:
		_show_confirmation("PASSWORDS_DO_NOT_MATCH")
		return

	_network.exec(&"sign_up", [
		email.to_lower(), password, password_confirm,
